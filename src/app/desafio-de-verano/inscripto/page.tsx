...
import { AgendarCalendario, ContadorEvento } from '@/components';
...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        description: "Instalaciones con altos standares de calidad. Un Jockey Gym cerca, no importa donde estes. Actualmente con 7 clubes en la provincia y más de 30 años en el sector. Cambiamos la vida de miles y miles de tucumanos que entrenan todos los días en nuestras instalaciones junto con los mejores profesionales de la actividad física y nutrición. Contamos con una amplia grilla de horarios para que puedas entrenar diariamiente y a tu ritmo. Buscamos constantemente adaptarnos a las necesidades de nuestros socios en cuanto a variedad y tipos de clases.",
        url: 'https://jockeygym.com.ar/desafio-de-verano/inscripto',
    ...
    twitter: {
        ...
        site: 'https://jockeygym.com.ar/desafio-de-verano/inscripto',
        creator: 'Jockey GYM',
        title: 'Gracias por inscribirte - Jockey GYM',
        description: "Instalaciones con altos standares de calidad. Un Jockey Gym cerca, no importa donde estes. Actualmente con 7 clubes en la provincia y más de 30 años en el sector. Cambiamos la vida de miles y miles de tucumanos que entrenan todos los días en nuestras instalaciones junto con los mejores profesionales de la actividad física y nutrición. Contamos con una amplia grilla de horarios para que puedas entrenar diariamiente y a tu ritmo. Buscamos constantemente adaptarnos a las necesidades de nuestros socios en cuanto a variedad y tipos de clases.",
    },
...
export default function InscriptoDesafioVeranoPage() {
    return (
        <main className="w-full lg:min-h-lvh flex flex-col justify-center items-center">
            <h1 className="sr-only">Gracias por inscribirte a nuestro desafio de verano JOCKEY GYM</h1>
            <section className="flex flex-col lg:flex-row-reverse justify-start items-start w-full lg:min-h-lvh">
                <div className='w-full lg:w-[70%] aspect-[4/3] lg:aspect-auto lg:min-h-lvh relative'>
                    <div className={`bg-[#00000049] size-full absolute top-0 left-0 z-20 ${styles.clip__diagonal}`}></div>
                    <img src={portada.src} alt='Gracias por inscribirte a nuestro desafio de verano' className={`${styles.clip__diagonal} size-full object-cover absolute top-0 left-0 z-10`}/>
                </div>
                <div className='w-full lg:w-[30%] lg:min-h-lvh px-4 lg:px-8 flex flex-col justify-center items-center py-12 lg:py-24 relative'>
                    <h2 className='w-full text-center text-jockey text-3xl lg:text-4xl'>¡Ya reservaste tu lugar!</h2>
                    <p className='mt-4 lg:mt-2 w-full text-center text-xl lg:text-3xl font-gotham'>Gracias por registrarte para participar en nuestro Desafio de verano.</p>
                    ...
                    <div className="mt-8 w-full text-center flex justify-center items-center">
                        <Link href={'/desafio-de-verano'} className="bg-jockey w-full py-3 lg:py-4 px-4 lg:px-8 rounded-lg text-xl lg:text-2xl text-white font-gotham-black">
                            Volver al inicio
                        </Link>
                    </div>
                </div>
