  ...
  return (
    <main className="grow w-full">
      <section className="w-full min-h-svh flex flex-col justify-center items-center relative">
        ...
        <Image src={sede_solar_portada} className="absolute top-0 left-0 w-full h-full object-cover -z-20" alt='Precios Jockey GYM'/>
        <div className="w-full xl:max-w-7xl	 px-4 xl:px-0 flex flex-col items-center justify-center relative text-center" data-aos="fade-down" data-aos-duration="300" data-aos-easing="ease-in-out">
          ...
          <h2 className="text-8xl font-extrabold text-white">SEDE EL SOLAR</h2>
          <div className="bg-jockey  py-4 px-8 rounded-lg flex justify-center items-center leading-none">
            <h3 className="text-5xl font-extrabold text-white relative top-1">AV. ACONQUIJA 1300</h3>
          </div>
      ...
      <section className="w-full min-h-screen bg-jockey flex flex-col justify-between items-center">
        <div className="grow w-full flex flex-col justify-end items-center" data-aos="fade-up" data-aos-duration="300" data-aos-easing="ease-in-out">
          <span className="flex flex-col justify-center items-center text-center">
            ...
            <b className="font-gotham-black text-white text-6xl">EL SOLAR</b>
          </span>
          <span className="mt-2 font-gotham text-white text-3xl ">AV. ACONQUIJA 1300</span>
        ...
        <table className="w-full max-w-7xl table table-fixed mt-16">
          ...
          <tbody className="divide-y-[1px] divide-jockey">
            <tr className='h-12 font-gotham-black bg-white hover:bg-zinc-100 transition-all duration-300 ease-in-out'>
              ...
              <td className='text-center py-4'><div className="flex justify-center items-center"><Circle/></div></td>
