  ...
  return (
    <main className="grow w-full">
      <section className="w-full min-h-svh flex flex-col justify-center items-center relative">
        ...
        <Image src={sede_catalinas_portada} className="absolute top-0 left-0 w-full h-full object-cover -z-20" alt='Precios Jockey GYM'/>
        <div className="w-full xl:max-w-7xl	 px-4 xl:px-0 flex flex-col items-center justify-center relative text-center" data-aos="fade-down" data-aos-duration="300" data-aos-easing="ease-in-out">
          ...
          <h2 className="text-8xl font-extrabold text-white">SEDE CATALINAS</h2>
          <div className="bg-jockey  py-4 px-8 rounded-lg flex justify-center items-center leading-none">
            <h3 className="text-5xl font-extrabold text-white relative top-1">AV. SOLDATI 380</h3>
          </div>
      ...
      <section className="w-full min-h-screen bg-jockey flex flex-col justify-between items-center">
        <div className="grow w-full flex flex-col justify-end items-center" data-aos="fade-up" data-aos-duration="300" data-aos-easing="ease-in-out">
          <span className="flex flex-col justify-center items-center text-center">
            ...
            <b className="font-gotham-black text-white text-6xl">CATALINAS</b>
          </span>
