        ...
        <main className="grow w-full">
            <section className="w-full min-h-svh flex flex-col justify-center items-center bg-gradient-to-b from-jockey from-25% to-white to-[125%] relative">
                ...
                <div className="mt-4 lg:mt-8 w-full max-w-xs font-gotham-black flex flex-col justify-center items-center gap-4 text-center relative z-30">
                    ...
                    <Link href='/desafio-de-verano' className="block text-lg lg:text-xl text-jockey w-full py-4 px-4 bg-white rounded-3xl hover:scale-105 drop-shadow-md transition-all duration-300 ease-in-out">Podes perder hasta 10 Kg antes de que termine el año</Link>
                </div>
