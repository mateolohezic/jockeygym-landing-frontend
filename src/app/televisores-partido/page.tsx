  ...
  return (
    <main className="grow w-full fixed top-0 left-0 z-[999999]">
      <section className="w-full flex justify-center items-stretch relative flex-wrap">
        <div className="w-8/12 h-svh flex flex-col justify-center items-center">
          ...
          {/* <div className="w-full grow bg-white border-t-2 border-jockey flex flex-col justify-center items-center"> */}
            <Marquee autoFill speed={150} gradient className="w-full grow bg-white border-t-2 border-jockey flex flex-col justify-center items-center">
              <h2 className="text-8xl text-jockey mx-2">HASTA 12 CUOTAS SIN INTERES JOCKEY GYM ANUAL VIP RENOVADOS -</h2>
            </Marquee>
        ...
        <div className="bg-green-500 w-4/12 border-l-2 border-jockey">
          <SwiperPartido/>
        </div>
      </section>
    </main>
